    ...
    public static void main(String[] args) {
        ...
        for (int lesson = 0; lesson < allGrades.length; lesson++) {
            for (int gradeIndex = 0; gradeIndex < allGrades[lesson].length; gradeIndex++) {
                allGrades[lesson][gradeIndex] = (int) (Math.random() * 101); // 0-100 arasında rastgele not üret
                System.out.println((lesson + 1) + ". ders " + (gradeIndex + 1) + ". not= " + allGrades[lesson][gradeIndex]);
            }
